...
/**
 * Thin proxy to the elippser Intelligence Layer (elippser-intel).
 *
 * In Docker: fetches from http://elippser-intel:4000/resolve
...
export async function GET(req: Request) {
  ...
  try {
    ...
    console.error('[elippser] Intel proxy error:', e instanceof Error ? e.message : e);
    return NextResponse.json(
