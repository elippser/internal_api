 ...
 *   - el mapa de dominios de DNS-CLOUDFLARE-roombir.md (y dns.inventory.ts),
...
export const INFRA_SERVICES: InfraService[] = [
  // --- PMS ---------------------------------------------------------------
  {
    ...
    label: "PMS",
    repo: "pms-core/app",
    githubRepo: "roombir/core-app-app",
    provider: "vercel",
    kind: "web",
    stack: "Next.js",
    host: "app.roombir.com",
  ...
  },
  {
    ...
    label: "API del PMS",
    repo: "pms-core/api",
    githubRepo: "roombir/core-app-api",
    provider: "vercel",
    kind: "api",
    stack: "Express",
    host: "api.roombir.com",
  ...
  // --- Reservas ----------------------------------------------------------
  {
    ...
    githubRepo: "roombir/booking-app-app",
    provider: "vercel",
    kind: "web",
    stack: "Next.js",
    host: "booking.roombir.com",
  ...
  },
  {
    ...
    githubRepo: "roombir/app-booking-public",
    provider: "vercel",
    kind: "web",
    stack: "Next.js",
    host: "web-booking.roombir.com",
  ...
  },
  {
    ...
    githubRepo: "roombir/booking-app-api",
    provider: "vercel",
    kind: "api",
    stack: "Express",
    host: "api-booking.roombir.com",
  ...
  // --- Habitaciones ------------------------------------------------------
  {
    ...
    label: "Habitaciones",
    repo: "rooms-app/web",
    githubRepo: "roombir/rooms-app_app",
    provider: "vercel",
    kind: "web",
    stack: "Next.js",
    host: "rooms.roombir.com",
  ...
  },
  {
    ...
    repo: "rooms-app/api",
    githubRepo: "roombir/rooms-app_api",
    provider: "vercel",
    kind: "api",
    stack: "Express",
    host: "api-rooms.roombir.com",
  ...
  // --- Huesped -----------------------------------------------------------
  {
    ...
    githubRepo: "roombir/public-side_staypass-app_app",
    provider: "vercel",
    kind: "web",
    stack: "Next.js",
    host: "staypass.roombir.com",
  ...
  },
  {
    ...
    githubRepo: "roombir/public-side_staypass-app_api",
    provider: "vercel",
    kind: "api",
    stack: "Express",
    host: "api-staypass.roombir.com",
  ...
  {
    id: "mkt-renderer",
    label: "Sitio de roombir",
    repo: "public-side/mkt-renderer",
    githubRepo: "elippser/internal_app-public-website",
    provider: "coolify",
    kind: "web",
    stack: "Next.js (nixpacks)",
    host: "roombir.com",
    extraHosts: ["www.roombir.com"],
    purpose: "El sitio comercial. Se edita desde Marketing > Sitio",
    nameHints: ["mkt-renderer", "roombir", "mkt"],
    criticality: "support",
    note: "Migrado de Vercel a Coolify el 30-08-2026 (en Vercel el dominio devolvia 404). OJO: el panel edita este repo por filesystem pero NO commitea ni pushea, y ahora el deploy sale de GitHub — un cambio de Marketing > Sitio no llega a produccion hasta que alguien pushee el repo. El nombre del repo NO se parece a la carpeta.",
  },
  {
    id: "linkhub-renderer",
    label: "LinkHub",
    repo: "public-side/linkhub-renderer",
    githubRepo: "roombir/public-side_linkhub-renderer",
    provider: "vercel",
    kind: "web",
    stack: "Next.js",
    host: "links.roombir.com",
  ...
  },
  {
    ...
    githubRepo: "roombir/public-side_web-renderer",
    provider: "coolify",
    kind: "web",
    stack: "Next.js (Docker)",
    host: "sites.roombir.com",
    extraHosts: ["*.sites.roombir.com"],
